...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "FHEHealthChecker",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FHEHealthChecker__factory>;
    getContractFactory(
      name: "FHEMentalHealthChecker",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FHEMentalHealthChecker__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.FHEHealthChecker>;
    getContractAt(
      name: "FHEMentalHealthChecker",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.FHEMentalHealthChecker>;
